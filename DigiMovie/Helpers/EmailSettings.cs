    ...
    public class EmailSettings
    {
        public static MailAddress GetMailAddress(EmailTypes type)
        {
            if(type == EmailTypes.Info)
                return new MailAddress("mftaspnet@gmail.com", "دیجی مووی");
            else if (type == EmailTypes.Newsletter)
                return new MailAddress("newsletter@gmail.com", "دیجی مووی");
            else if (type == EmailTypes.NoReply)
                return new MailAddress("no-reply@gmail.com", "دیجی مووی");
            else 
                return new MailAddress("support@gmail.com", "دیجی مووی");
        }
